...
def diagnose_d128_values():
    ...
    print(f"PY Rec Head (first 4): {x_rec_py.view(-1)[:4].tolist()}")
    print(f"TR Rec Head (first 4): {x_rec_tr.view(-1)[:4].tolist()}")
